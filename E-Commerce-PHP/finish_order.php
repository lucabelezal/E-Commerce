                                     ...
                                     <div class="box-authentication">
                                        ...
                                        <form action="sql_helper/execute_product_order.php" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    Boleto
                                                    <input name="payment" value="BOLETO" class="form-check-input" type="radio">
                                                </div>
                                            </div>
                                            <br>
                                            <hr>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                         ...
                                                         <input name="" placeholder="4716 0967 5425 6597" style="width: 100%;" name="adress_complement" id="adress_complement" type="text" class="form-control form-check-input">
                                                     </div>
                                                 </div>
                                                 <div class="col-md-6">
                                                     <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="adress_complement"><b>CVV:</b></label>
                                                    <input name="" style="width: 100%;" name="adress_complement" id="adress_complement" type="text" placeholder="295" class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="adress_complement"><b>Data de validade:</b></label>
                                                    <input name="" style="width: 100%;" name="adress_complement" id="adress_complement" type="text" placeholder="MM/YY" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label for="adress_complement"><b>Nome do titular:</b></label>
                                                    <input name="" style="width: 100%;" name="adress_complement" id="adress_complement" type="text" placeholder="MARCOS E. SILVA" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                               ...
                                               <p><b>Boleto</b></p>
                                               <br>
                                               <button style="width: 50%;" class="btn-primary btn" type="" value="" name="">Gerar Boleto</button>
                                           </div>
                                       </div>
                                       <hr>                          
                                       <div class="">
