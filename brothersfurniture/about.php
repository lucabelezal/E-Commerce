    ...
    <div class="columns-container">
        <div class="container" id="columns">
            ...
            <div class="breadcrumb clearfix">
                ...
                <span class="navigation_page">Sobre nós</span>
            </div>
            <!-- ./breadcrumb -->
            ...
            <div class="row">
                ...
                <div class="column col-xs-12 col-sm-3" id="left_column">
                    ...
                    <div class="block left-module">
                        <p class="title_block">Informações</p>
                        <div class="block_content">
                            <!-- layered -->
                            <div class="layered layered-category">
                                <div class="layered-content">
                                    <ul class="tree-menu">
                                        <li class="active"><span></span><a href="#">Sobre nós</a></li>
                                        <li><span></span><a href="#">Informações de entrega</a></li>
                                        <li><span></span><a href="#">Política de Privacidade</a></li>
                                        <li><span></span><a href="#">Termos &amp; Condições</a></li>
                                        <li><span></span><a href="#">Nossos contatos</a></li>
                                        <li><span></span><a href="#">FAQ</a></li>
                                        <li><span></span><a href="#">Mapa do Site</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- ./layered -->
                ...
                <div class="center_column col-xs-12 col-sm-9" id="center_column">
                    ...
                    <h2 class="page-heading">
                        <span class="page-heading-title2">Sobre nós</span>
                    </h2>
                    <!-- Content page -->
