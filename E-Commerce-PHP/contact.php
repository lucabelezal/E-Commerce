    ...
    <div class="container" id="columns">
        ...
        <div id="contact" class="page-content page-contact">
            ...
            <div class="row">
                ...
                <form action="sql_helper/execute_user_message.php" method="post" >
                    <div class="col-sm-6">
                        <h3 class="page-subheading">FORMULÁRIO DE CONTATO</h3>
                        <div class="contact-form-box">
                            <div class="form-selector">
                                <label>Título do assunto</label>
                                <select name="formSubject" class="form-control input-sm" id="subject">
                            ...
                            <div class="form-selector">
                                ...
                                <input name="number_requested" type="text" class="form-control input-sm" id="order_reference" />
                            </div>
                            <div class="form-selector">
                            ...
                            <div class="form-selector">
                                <button id="btn-send-contact" type="submit" class="btn">Enviar</button>
                            </div>
                        </div>    
                    </div>
                </form>
